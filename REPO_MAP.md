...
| `create_role_guide.py` | _(TODO: describe — auto-added 2026-06-25 by repo_map_check)_ |
| `desktop.ini` | _(TODO: describe — auto-added 2026-08-04 by repo_map_check)_ |
## Directories

<!-- REPO-STRUCTURE:AUTO (generated by repo_map_check.py --sync · do not hand-edit) -->
_Auto-generated structure snapshot — repo_map_check.py --sync (2026-08-04). Do not hand-edit between these markers; curated descriptions live outside._
...
| `.agents\skills\content/` | 1 | 5 |
| `.agents\skills\content\ascii_flow/` | 2 | 0 |
| `.agents\skills\content\doc_builder/` | 2 | 0 |
| `.agents\skills\content\interactive_teaching_material/` | 2 | 1 |
| `.agents\skills\content\interactive_teaching_material\assets/` | 4 | 0 |
| `.agents\skills\content\mobile-ux-redesign/` | 1 | 2 |
| `.agents\skills\content\mobile-ux-redesign\assets/` | 3 | 0 |
| `.agents\skills\content\mobile-ux-redesign\references/` | 3 | 0 |
...
| `.agents\skills\harness/` | 0 | 15 |
| `.agents\skills\harness\debug/` | 1 | 0 |
| `.agents\skills\harness\flow_summarizer/` | 1 | 0 |
...
| `.agents\skills\harness\harness_setup/` | 1 | 0 |
| `.agents\skills\harness\loop_engineer/` | 2 | 0 |
...
| `.agents\skills\harness\ticket_intake/` | 2 | 0 |
...
| `backend\dist\api\routes/` | 64 | 0 |
| `backend\dist\config/` | 20 | 0 |
| `backend\dist\controllers/` | 20 | 0 |
| `backend\dist\models/` | 88 | 0 |
| `backend\dist\scratch/` | 8 | 0 |
| `backend\dist\scripts/` | 24 | 0 |
| `backend\dist\services/` | 20 | 8 |
...
| `backend\dist\services\scanData/` | 12 | 0 |
| `backend\dist\services\skill/` | 4 | 0 |
| `backend\dist\services\wage/` | 20 | 0 |
| `backend\dist\types/` | 4 | 0 |
| `backend\dist\utils/` | 8 | 0 |
| `backend\keys/` | 1 | 0 |
| `backend\logs/` | 8 | 0 |
...
| `frontend\public\doc\manual/` | 12 | 2 |
...
| `frontend\public\doc\manual\assets\se_fm/` | 29 | 0 |
...
| `frontend\src\pages\workspace/` | 2 | 1 |
| `frontend\src\pages\workspace\components/` | 1 | 0 |
...
| `uploads/` | 0 | 2 |
| `uploads\daily-reports/` | 0 | 1 |
| `uploads\daily-reports\imports/` | 25 | 0 |
| `uploads\tasks/` | 0 | 10 |
| `uploads\tasks\PD-0001-0000001/` | 0 | 2 |
| `uploads\tasks\PD-0001-0000001\labor/` | 4 | 0 |
| `uploads\tasks\PD-0001-0000001\site/` | 5 | 0 |
| `uploads\tasks\PD-0001-0000002/` | 0 | 2 |
| `uploads\tasks\PD-0001-0000002\labor/` | 4 | 0 |
| `uploads\tasks\PD-0001-0000002\site/` | 4 | 0 |
| `uploads\tasks\STR-0001-0000001/` | 0 | 2 |
| `uploads\tasks\STR-0001-0000001\labor/` | 4 | 0 |
| `uploads\tasks\STR-0001-0000001\site/` | 4 | 0 |
| `uploads\tasks\TASK-0000001/` | 0 | 3 |
| `uploads\tasks\TASK-0000001\certs/` | 2 | 0 |
| `uploads\tasks\TASK-0000001\labor/` | 6 | 0 |
| `uploads\tasks\TASK-0000001\site/` | 6 | 0 |
| `uploads\tasks\TASK-0000002/` | 0 | 2 |
| `uploads\tasks\TASK-0000002\labor/` | 4 | 0 |
| `uploads\tasks\TASK-0000002\site/` | 4 | 0 |
| `uploads\tasks\TASK-0000003/` | 0 | 2 |
| `uploads\tasks\TASK-0000003\labor/` | 2 | 0 |
| `uploads\tasks\TASK-0000003\site/` | 2 | 0 |
| `uploads\tasks\TASK-0000004/` | 0 | 2 |
| `uploads\tasks\TASK-0000004\labor/` | 2 | 0 |
| `uploads\tasks\TASK-0000004\site/` | 2 | 0 |
| `uploads\tasks\TASK-0000005/` | 0 | 2 |
| `uploads\tasks\TASK-0000005\labor/` | 2 | 0 |
| `uploads\tasks\TASK-0000005\site/` | 2 | 0 |
| `uploads\tasks\TASK-0000006/` | 0 | 3 |
| `uploads\tasks\TASK-0000006\certs/` | 1 | 0 |
| `uploads\tasks\TASK-0000006\labor/` | 4 | 0 |
| `uploads\tasks\TASK-0000006\site/` | 4 | 0 |
| `uploads\tasks\TASK-0000007/` | 0 | 2 |
| `uploads\tasks\TASK-0000007\labor/` | 2 | 0 |
| `uploads\tasks\TASK-0000007\site/` | 2 | 0 |
<!-- /REPO-STRUCTURE:AUTO -->
...
### `logs/`
_(TODO: describe — auto-added 2026-06-25 by repo_map_check)_
