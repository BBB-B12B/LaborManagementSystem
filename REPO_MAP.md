...
| `frontend\src\pages\daily-reports/` | 3 | 3 |
| `frontend\src\pages\daily-reports\[id]/` | 2 | 0 |
| `frontend\src\pages\daily-reports\components/` | 4 | 0 |
| `frontend\src\pages\daily-reports\mobile/` | 2 | 0 |
| `frontend\src\pages\dc-management/` | 2 | 2 |
| `frontend\src\pages\dc-management\[id]/` | 1 | 0 |
| `frontend\src\pages\dc-management\components/` | 3 | 0 |
| `frontend\src\pages\login/` | 3 | 0 |
| `frontend\src\pages\management/` | 1 | 2 |
| `frontend\src\pages\management\company-holidays/` | 1 | 0 |
| `frontend\src\pages\management\social-security-rules/` | 1 | 1 |
| `frontend\src\pages\management\social-security-rules\components/` | 1 | 0 |
| `frontend\src\pages\member-management/` | 2 | 2 |
| `frontend\src\pages\member-management\[id]/` | 1 | 0 |
| `frontend\src\pages\member-management\components/` | 3 | 0 |
| `frontend\src\pages\overtime/` | 2 | 2 |
| `frontend\src\pages\overtime\[id]/` | 2 | 0 |
| `frontend\src\pages\overtime\components/` | 1 | 0 |
| `frontend\src\pages\project-management/` | 2 | 2 |
| `frontend\src\pages\project-management\[id]/` | 1 | 0 |
| `frontend\src\pages\project-management\components/` | 3 | 0 |
| `frontend\src\pages\scan-data-monitoring/` | 2 | 1 |
| `frontend\src\pages\scan-data-monitoring\components/` | 0 | 0 |
...
| `frontend\src\pages\workspace\components/` | 9 | 0 |
