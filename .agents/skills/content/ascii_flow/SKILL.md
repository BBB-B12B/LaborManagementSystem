...
Full char palette, templates, guidelines, connectors, doc structure: `@.agents/skills/content/ascii_flow/SKILL_detail.md`
...
@.agents/skills/content/ascii_flow/SKILL_detail.md
