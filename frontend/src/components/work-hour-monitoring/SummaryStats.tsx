  ...
  const themes = {
    blue: {
      bg: active
        ...
        : `linear-gradient(135deg, ${RECON_COLORS.BLUE.NAVY} 0%, ${RECON_COLORS.BLUE.ROYAL} 100%)`,
...
const SummaryStats: React.FC<Props> = ({
  ...
  const resolutionRate =
    totalAnomalies > 0 ? ((stats.resolvedCount / totalAnomalies) * 100).toFixed(1) : '0.0';
      ...
      <Grid container spacing={2}>
              ...
              <Stack direction="column" alignItems="center" spacing={1} sx={{ flex: 1 }}>
                <Box
                  sx={{
                    ...
                    borderRadius: '12px',
                    background:
                      activeStatus === 'all' ? 'rgba(0,0,0,0.05)' : 'rgba(255,255,255,0.12)',
                ...
                >
                  <Typography
                    variant="caption"
                    sx={{ opacity: 0.8, fontWeight: 700, fontSize: '0.6rem', display: 'block' }}
                  >
                    แถวข้อมูลสะสม
                  </Typography>
        ...
        <Grid item xs={12} md={4}>
          <StatCard
            ...
            colorTheme="green"
            active={
              activeStatus === 'normal' || activeStatus === 'all_normal' || activeStatus === 'leave'
            }
            ...
            <Stack direction="row" spacing={1} alignItems="center" sx={{ height: '100%' }}>
              <Box sx={{ flex: 1.2 }}>
                <Typography
                  ...
                  sx={{
                    color:
                      activeStatus === 'normal' ? 'inherit' : RECON_COLORS.NEUTRAL.textSecondary,
                    textTransform: 'uppercase',
                    letterSpacing: 0.5,
                    fontSize: '0.65rem',
                  }}
                ...
                <Stack direction="row" alignItems="baseline" spacing={1}>
                  ...
                  <Typography
                    variant="caption"
                    fontWeight="800"
                    sx={{ color: RECON_COLORS.BLUE.LIGHT }}
                  >
                    รายการ
                  </Typography>
                </Stack>
              ...
              >
                <Box
                  sx={{
                    ...
                    height: 60,
                    borderRadius: '50%',
                    background: `${RECON_COLORS.GREEN.accent}10`,
                    zIndex: 0,
                  }}
                />
                <CheckCircleIcon
                  sx={{
                    fontSize: 60,
                    color: RECON_COLORS.GREEN.activeBorder,
                    position: 'relative',
                    zIndex: 1,
                  }}
                />
                    ...
                    sx={{
                      ...
                      '@keyframes pulse': {
                        '0%': {
                          transform: 'scale(1)',
                          opacity: 1,
                          boxShadow: `0 0 0 0 ${RECON_COLORS.RED.activeBorder}40`,
                        },
                        '70%': {
                          transform: 'scale(1.5)',
                          opacity: 0,
                          boxShadow: `0 0 0 10px ${RECON_COLORS.RED.activeBorder}0`,
                        },
                        '100%': {
                          transform: 'scale(1)',
                          opacity: 0,
                          boxShadow: `0 0 0 0 ${RECON_COLORS.RED.activeBorder}0`,
                        },
                      },
                    }}
                  />
                ...
                <Stack direction="row" alignItems="center" spacing={0.5}>
                  {isLoading ? (
                    ...
                    <Typography
                      variant="h2"
                      fontWeight="900"
                      sx={{ fontSize: '3rem', color: RECON_COLORS.RED.activeBorder, lineHeight: 1 }}
                    >
                      {stats.pendingCount}
                    </Typography>
                  )}
                  <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                    <InfoIcon
                      sx={{ fontSize: 20, color: RECON_COLORS.RED.activeBorder, mb: -0.5 }}
                    />
                    <Typography
                      variant="caption"
                      sx={{
              ...
              <Stack spacing={0.75} sx={{ flex: 1.3 }}>
                ...
                <Box
                  ...
                  sx={{
                    ...
                    border: '1px solid',
                    borderColor:
                      activeStatus === 'abnormal_fixed'
                        ? RECON_COLORS.BLUE.activeBorder
                        : RECON_COLORS.BLUE.border,
                    textAlign: 'center',
                    cursor: 'pointer',
                    '&:hover': {
                      transform: 'scale(1.02)',
                      borderColor: RECON_COLORS.BLUE.activeBorder,
                    },
                  }}
                >
                  <Stack direction="row" spacing={0.5} justifyContent="center" alignItems="center">
                    ...
                    <Typography
                      variant="caption"
                      fontWeight="900"
                      sx={{ color: RECON_COLORS.BLUE.text, fontSize: '0.65rem' }}
                    >
                      แก้ไขแล้ว
                    </Typography>
                  </Stack>
                  <Typography
                    variant="h6"
                    fontWeight="900"
                    sx={{ color: RECON_COLORS.BLUE.text, lineHeight: 1 }}
                  >
                ...
                >
                  ...
                  {!isLoading && (
                    ...
                    >
                      {stats.resolvedCount.toLocaleString()} / {totalAnomalies.toLocaleString()}{' '}
                      รายการ
                    </Typography>
                  )}
                </Box>
