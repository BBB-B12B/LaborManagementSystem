...
export default function TaskDailyReportModal({
  open,
  onClose,
  task,
  onTaskUpdated,
  initialDate,
}: TaskDailyReportModalProps) {
    ...
    async (forceRefresh = false) => {
      ...
      try {
        ...
        if (isSupportTask) {
          ...
          siteReports = await dailyReportService
            .getAllTaskReports(task.id, forceRefresh, false)
            .catch(() => []);
        }
        ...
        const addToMap = (report: any, type: 'site' | 'support') => {
          ...
          if (
            ...
            ('_seconds' in report.reportDate || 'seconds' in report.reportDate)
          ) {
  ...
  const handleUnlockClick = (event: React.MouseEvent<HTMLElement>) =>
    setUnlockAnchorEl(event.currentTarget);
  ...
  const CustomPickersDay = (props: PickersDayProps) => {
    ...
    const isExplicitlyUnlocked = !!(
      unlockData && isBefore(new Date(), new Date(unlockData.unlockedUntil))
    );
    ...
    const isLocked =
      (isPast && isBefore(day, subDays(today, 3)) && !isExplicitlyUnlocked) ||
      (isBeforeBound && !isExplicitlyUnlocked);
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center">
            ...
            <Stack direction="row" alignItems="center" spacing={2} sx={{ mt: 0.5 }}>
              <Typography variant="h6" sx={{ fontWeight: 800, color: '#1c1e2b' }}>
                ...
                {isActingAsSupport && task?.supportTaskName
                  ...
                  : task?.subtaskName
                    ? `${task.taskName} > ${task.subtaskName}`
                    : task?.taskName}
              </Typography>
              ...
              >
                ...
                >
                  {isActingAsSupport
                    ? task?.supportAssignees?.[0]?.name
                      ? task.supportAssignees[0].name.substring(0, 2)
                      : 'NA'
          ...
          <Stack direction="row" spacing={1.5} alignItems="center">
            {pendingUnlockDates.length > 0 && (
              ...
              >
                <Badge
                  badgeContent={pendingUnlockDates.length}
                  color="warning"
            ...
            {task?.status === 'completed' && (
              ...
              >
                ...
                <Typography variant="body2" sx={{ fontWeight: 700 }}>
                  อนุมัติแล้วเมื่อ:{' '}
                  {task.updatedAt
                    ? format(new Date(task.updatedAt), 'dd/MM/yyyy HH:mm', { locale: th })
                    : '-'}
                </Typography>
              </Box>
            )}
            ...
            <Grid item xs={12} md={5}>
              <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                >
                  ...
                  {(() => {
                    const requestsField = isActingAsSupport
                      ? 'supportUnlockRequests'
                      : 'unlockRequests';
                    const hasRequest =
                      task?.[requestsField] && task[requestsField][selectedDateStr];
                    return hasRequest ? (
                      <Button
                ...
                <Box sx={{ border: '1px solid #eef0f4', borderRadius: 4, p: 2, flexGrow: 1 }}>
                  ...
                  <Stack spacing={1.5} sx={{ mt: 3, px: 2 }}>
                    ...
                    >
                      ...
                      <Stack direction="row" alignItems="center" spacing={1}>
                        <Box
                          sx={{ width: 8, height: 8, bgcolor: '#a855f7', borderRadius: '50%' }}
                        />
                        <Typography variant="caption" sx={{ color: '#475569', fontWeight: 600 }}>
                          ขอปลดล็อคลงย้อนหลัง
                        </Typography>
                            ...
                            {task?.isSupportRequest ? (
                              <Stack direction="row" spacing={3} sx={{ mt: 1 }}>
                                <Box sx={{ textAlign: 'center' }}>
                                  ...
                                  >
                                    {selectedSummary.siteWorkerCount}{' '}
                                    <Typography
                                      component="span"
                                      variant="caption"
                                ...
                                <Box sx={{ textAlign: 'center' }}>
                                  ...
                                  <Typography
                                    ...
                                    sx={{ fontWeight: 800, color: '#0f172a', lineHeight: 1 }}
                                  >
                                    {selectedSummary.supportWorkerCount}{' '}
                                    <Typography
                                      component="span"
                                      variant="caption"
                                      sx={{ fontWeight: 600, color: '#64748b' }}
                                  ...
                                  <Stack spacing={1}>
                                    <Stack direction="row" justifyContent="space-between">
                                      ...
                                      <Typography variant="caption" sx={{ fontWeight: 700 }}>
                                        {selectedSummary.siteRegularHours} ชม.
                                      </Typography>
                                    </Stack>
                                    <Stack direction="row" justifyContent="space-between">
                                      <Typography variant="caption" sx={{ color: '#64748b' }}>
                                      ...
                                      <Typography variant="caption" sx={{ fontWeight: 700 }}>
                                        {selectedSummary.siteOtMorning > 0
                                          ? `${selectedSummary.siteOtMorning} ชม.`
                                          : '-'}
                                      </Typography>
                                    </Stack>
                                    <Stack direction="row" justifyContent="space-between">
                                      ...
                                      <Typography variant="caption" sx={{ fontWeight: 700 }}>
                                        {selectedSummary.siteOtNoon > 0
                                          ? `${selectedSummary.siteOtNoon} ชม.`
                                          : '-'}
                                      </Typography>
                                    </Stack>
                                    <Stack direction="row" justifyContent="space-between">
                                      ...
                                      <Typography variant="caption" sx={{ fontWeight: 700 }}>
                                        {selectedSummary.siteOtEvening > 0
                                          ? `${selectedSummary.siteOtEvening} ชม.`
                                          : '-'}
                                      </Typography>
                                    </Stack>
                                  </Stack>
                                ...
                                <Box sx={{ flex: 1 }}>
                                  ...
                                  <Stack spacing={1}>
                                    <Stack direction="row" justifyContent="space-between">
                                      ...
                                      <Typography variant="caption" sx={{ fontWeight: 700 }}>
                                        {selectedSummary.supportRegularHours} ชม.
                                      </Typography>
                                    </Stack>
                                    <Stack direction="row" justifyContent="space-between">
                                      <Typography variant="caption" sx={{ color: '#64748b' }}>
                                      ...
                                      <Typography variant="caption" sx={{ fontWeight: 700 }}>
                                        {selectedSummary.supportOtMorning > 0
                                          ? `${selectedSummary.supportOtMorning} ชม.`
                                          : '-'}
                                      </Typography>
                                    </Stack>
                                    <Stack direction="row" justifyContent="space-between">
                                      ...
                                      <Typography variant="caption" sx={{ fontWeight: 700 }}>
                                        {selectedSummary.supportOtNoon > 0
                                          ? `${selectedSummary.supportOtNoon} ชม.`
                                          : '-'}
                                      </Typography>
                                    </Stack>
                                    <Stack direction="row" justifyContent="space-between">
                                      ...
                                      <Typography variant="caption" sx={{ fontWeight: 700 }}>
                                        {selectedSummary.supportOtEvening > 0
                                          ? `${selectedSummary.supportOtEvening} ชม.`
                                          : '-'}
                                      </Typography>
                                    </Stack>
                                  </Stack>
                              ...
                              <Stack direction="row" spacing={3} sx={{ mt: 1 }}>
                                <Box sx={{ textAlign: 'center' }}>
                                  ...
                                  <Typography
                                    ...
                                    sx={{ fontWeight: 800, color: '#0f172a', lineHeight: 1 }}
                                  >
                                    {selectedSummary.siteTotalHours}{' '}
                                    <Typography
                                      component="span"
                                      variant="caption"
                                      sx={{ fontWeight: 600, color: '#64748b' }}
                                ...
                                <Box sx={{ textAlign: 'center' }}>
                                  ...
                                  <Typography
                                    ...
                                    sx={{ fontWeight: 800, color: '#0f172a', lineHeight: 1 }}
                                  >
                                    {selectedSummary.supportTotalHours}{' '}
                                    <Typography
                                      component="span"
                                      variant="caption"
                                      sx={{ fontWeight: 600, color: '#64748b' }}
                            ...
                            {(() => {
                              const allPhotos = [
                                ...(selectedSummary.hasSiteReport
                                  ? selectedSummary.sitePhotos
                                  : []),
                                ...(selectedSummary.hasSiteReport
                                  ? selectedSummary.laborPhotos
                                  : []),
                    ...
                    <Box sx={{ mt: 2 }}>
                      {selectedSummary.hasSiteReport ? (
                        ...
                        >
                          <Typography
                            variant="body2"
                            sx={{ fontWeight: 700, color: '#334155', mb: 1, textAlign: 'center' }}
                          >
                            ความคืบหน้าของวัน
                          </Typography>
                          <Typography
                            variant="subtitle1"
                            sx={{ fontWeight: 800, color: '#059669', textAlign: 'center', mb: 0.5 }}
                          >
                              ...
                              <Box
                                sx={{
                                  ...
                                  borderBottomRightRadius:
                                    selectedSummary.progressAdded === 0 ? 1 : 0,
                                }}
                              />
                            )}
                            ...
                            {selectedSummary.progressAdded > 0 && (
                              <Box
                                sx={{
                                  position: 'absolute',
                                  top: 0,
                                  left: `${selectedSummary.pastProgress}%`,
                                  height: 24,
                                  ...
                                  borderBottomLeftRadius:
                                    selectedSummary.pastProgress === 0 ? 1 : 0,
                                  display: 'flex',
                                  alignItems: 'center',
                                  justifyContent: 'center',
                                }}
                              >
                                {selectedSummary.progressAdded > 5 && (
                                  <Typography
                                    variant="caption"
                                    sx={{ fontWeight: 800, color: '#ffffff', zIndex: 1 }}
                                  >
                        ...
                        >
                          <Typography
                            variant="body2"
                            sx={{ fontWeight: 600, color: '#94a3b8', textAlign: 'center' }}
                          >
