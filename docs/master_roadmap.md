...
- [X] T-020-001-04-01: แก้ไขบัคหน้าต่างรายการงานฝั่งซ้ายว่างเปล่าเมื่อสลับโหมดทำรายงาน/คำขอของหัวหน้างาน (Sidebar closed and no toggle button) (→ ERR-075) · attempts: 1 · tool_calls: 72
