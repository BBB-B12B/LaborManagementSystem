...
const serviceAccountPath = path.resolve(__dirname, '../../keys/labor-management-system-33b06-firebase-adminsdk-fbsvc-c5a6266fd9.json');
...
async function migrateScanData() {
    ...
    console.log(`Grouped ${processedCount} legacy records into ${dailyMap.size} daily summaries. Skipped ${skippedCount} existing new-format records.`);
